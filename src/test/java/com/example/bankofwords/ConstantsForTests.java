...
public class ConstantsForTests {
    public static final String TESTING_DB_URL = "jdbc:mysql://localhost:3306/bank_of_words_test_db";
    public static final String TESTING_DB_USERNAME = "user";
    public static final String TESTING_DB_PASSWORD = "rootroot";
    public static final String TESTING_DB_CLASS_NAME = "com.mysql.jdbc.Driver";

    public static void populateDatabase(BasicDataSource dataSource) {
