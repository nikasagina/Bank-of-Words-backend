...
public class UploadController {
    ...
    @Autowired
    public UploadController(WordDAO wordDAO, UserDAO userDAO, JwtUtil jwtUtil, WordUtil wordUtil,
                            PdfParser pdfParser, MobiParser mobiParser, EpubParser epubParser) {
...
//                    case "epub" -> unknownWords = epubParser.parseEpub(file);
                ...
                unknownWords.forEach(word -> {
                    if (!wordDAO.userWordsContain(userId, word) && WordUtil.dictionaryContainsWord(word)) {
                        wordDAO.addWord(userId, word, WordUtil.getDefinition(word));
                    }
                });
                ...
                response.put("added words", unknownWords);
